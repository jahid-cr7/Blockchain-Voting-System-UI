  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-blue-200 via-purple-200 to-pink-200 items-center justify-center p-4">
      ...
      >
        ...
        >
          <img
            src="https://i.ibb.co/Rkh19t1T/blockchain-voting-removebg-preview.png"
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-2 md:mb-4 text-black">
          ...
          <p className="text-sm text-gray-500 mt-3">
            ...
            <Link
              to="/register"
              className="text-gray-800 font-bold hover:text-[#444] "
            >
              Register
            </Link>
          </p>
